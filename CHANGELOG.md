...
* **fix**:
  ...
  * 修正 Admin Panel 課程列表在切換狀態後，頁面未自動刷新的問題。加入 `router.refresh()` 確保在 API 回應成功後，會強制更新伺服器端資料緩存，讓切換頁面或重新整理時能顯示正確的最新狀態。# #   v 5 . 4 . 0   -   R e a d e r   M o d e   &   L e s s o n   C u s t o m i z a t i o n   ( 2 0 2 5 - 1 2 - 0 9 )  
  
 *   * * f e a t * * :  
  
     *   ? R�? ? ��? ? ��S�? ��? nd��? ? � ��[ihd!�H��� �dF�? ? ��� ��G�a? R e a d e r   M o d e   ( ? �h? �t*"? ) �V��? ���fY�? ;R� �����sT�\�? ? 9�? �a�? �V��? ? l`?  
         *   * * F o c u s   M o d e * * :   ��� ? �? ? ��? v�Q���d;�? ? �h? ? ���? ���? ���? Xo? �v��? ���{k�d+�~�? ?  
         *   * * ����? ? ����* * :   ? ��?   D a r k   ( ? �䫎) ? ��i g h t   ( ? �b? ? �N? ) ? ��e p i a   ( �^t�ze�b��) ? ��a v y   ( v�h? )   Q�#�? T�Eh? ? ��? ? �b? ����? ? �h? ? cU? ? ?  
         *   * * nd�? �ayb? * * :   ? *��w? Tn? nd�KN�d? ( S m a l l / M e d i u m / L a r g e ) �V���? �H��� ? ���hd~�� ?  
     *   _��^}? x��? ��? ? �Y�? ;R� ��? ? 1�+g��VR? �V���띒��? ��)�? ? ����n� `? ? AR? c��{? ��� ? !n? nd��? �dF�? ? ?  
  
 # #   v 5 . 3 . 3   -   A d m i n   L i s t   R e f r e s h   F i x   ( 2 0 2 5 - 1 2 - 0 9 )  
 